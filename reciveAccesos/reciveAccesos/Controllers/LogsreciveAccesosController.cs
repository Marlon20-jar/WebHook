...
namespace reciveAccesos.Controllers
{
    [ApiController]
    [Route("api/LogsreciveAccesos")]
    public class LogsreciveAccesosController : ControllerBase
    {
        [HttpGet]
        public IActionResult GetLogs()
        {
            try
            {
                ...
                string logFilePath = $"logs/reciveAccesos_log{today}.txt";
